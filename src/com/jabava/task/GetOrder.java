...
public class GetOrder {
	 ...
	 * <pre>
	 * @author steven.chen
	 * @date 2016年3月25日 下午6:52:08 
	 * </pre>
	 *
	 * @param hroPact
	 * @throws Exception
	 */
	public void getOrderByProcotolCode(HroPactInfo hroPact) throws Exception{
		
		List<HroPactInfo> hroPactInfoList= new ArrayList<HroPactInfo>();
		hroPactInfoList.add(hroPact);
