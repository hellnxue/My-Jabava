...
public interface EhrOrganizationMapper {
	...
	List<EhrOrganization> selectAuthorisedByCompanyId(Long companyId);
  ...
  List<EhrOrganization> findByLevel(@Param("companyId")Long companyId, @Param("level")Integer level);
}
