 ...
 * @author 郑长山
 */
public class MobileRecvListener implements EMPPRecvListener {
	...
	protected MobileRecvListener() {

	}

	public MobileRecvListener(EmppApi emppApi) {
	...
	public void onMessage(EMPPObject message) {
		if (message instanceof EMPPUnAuthorization) {
			...
			System.out.println("客户端无权执行此操作 commandId="
	...
	public void OnClosed(Object object) {
		...
		MobileRecvListener listener = new MobileRecvListener(emppApi);
