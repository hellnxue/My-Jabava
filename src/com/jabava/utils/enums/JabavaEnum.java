...
//	}
	...
	public enum HroCardType {
		/** 1 身份证 */
		 ...
		 HroCardType(String value, String name) {
			this.value = value;
			this.name = name;
		}
	 ...
	 *
	 * @version $Id: EnumConstents.java, 
	 * v 0.1 2016年4月29日 上午11:25:06 
	 * <pre>
	 * @author steven.chen
	 * @date 2016年4月29日 上午11:25:06 
	 * </pre>
	 */
	public enum SocialSecurityOrAccumulationFundStatus {
		/** 0 草稿 */
		DRAFT(0),
		/** 1 在缴 */
		IN_PAY(1),
		...
		private Integer value;
		SocialSecurityOrAccumulationFundStatus(Integer value) {
			this.value = value;
		}
	...
	/**
	 * 文件分类
	 * 100-图标图片；200-模板；300-数据；999-未分类
	 */
	...
	/**
	 * 报表范围类型
	 * 1-平台级系统管理员；2-企业级系统管理员；3-普通用户；4-HR；
	 */
