    ...
    <div class="row">
            ...
            <div class="hpanel">
                <div class="panel-heading">
                    <h4 class="text-center font-bold">
                      <a href="insuranceDocs/listDocs" type="button" class="btn btn-success btn-sm pull-left btn-return m-r-md">返回</a>
                        员工社保档案-缴费明细
                    </h4>
                </div>
      ...
      <ul role="tabList" class="nav nav-tabs" id="">
              ...
              <li role="payDetails" class="active">
                <a data-toggle="tab" href="#payDet">缴费明细</a>
              </li>
      </ul>
                 ...
                 <tr>
                  ...
                  <th style=" padding:0;">
                      ...
                      <div class="baoxian">
                          ...
                          <li>企业补缴金额</li>
                          <li>个人补缴金额</li>
                          <li class="lasts">补缴月数</li>
                          </ul>
                      </div>
                  </th>
                  <th style=" padding:0;">
                      <div class="ylbx2">医疗保险</div>
                      <div class="yiliao">
                          <ul>
                          <li>企业基金</li>
                          <li>个人基金</li>
