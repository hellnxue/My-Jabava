  ...
  <div class="content animate-panel">
    <div class="row">
            ...
            <div class="hpanel">
                <div class="panel-heading">
                    <h4 class="text-center font-bold">
                     ...
                     ${requestScope.afPaymentBill.accumulationFundAccountName}${requestScope.afPaymentBill.month}月清单明细-公积金本月变更
                    </h4>
                </div>
      <ul role="tabList" class="nav nav-tabs m-t-md" id="">
          ...
          <li role="payDetails">
            <a href="javascript: void(0);" onclick="viewPerson('ZY');">本月增员</a>
          </li>
          <li role="payDetails">
      ...
      <ul role="tabList" class="nav nav-tabs m-t-md" id="">
              <li role="payDetails" class="active">
                <a data-toggle="tab" href="#tab-1">调基</a>
              </li>
              <li role="payDetails">
                <a data-toggle="tab" href="#tab-2">补缴</a>
              </li>
      </ul>
      <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
          <div class="panel-body"> 
            <div class="table-responsive">
              <table id="tjTable" class="table table-bordered table-hover detailTable" width="100%">
              <thead>
              </thead>
              <tbody>
              </tbody>
        ...
        <!-- tab1 end -->
         <div id="tab-2" class="tab-pane">
          <div class="panel-body"> 
            <div class="table-responsive">
              <table id="bjTable" class="table table-bordered table-hover detailTable" width="100%">
              <thead>
              </thead>
              <tbody>  
              </tbody>
...
<script type="text/javascript">
	...
	$(function () {
		$('.m-r-md').click(function(){
			 $('#billForm').attr('action','afPaymentBill/toListPaymentBill');
		     $('#billForm').submit();
		});
    ...
    function viewPerson(type){
    	$('#t').val(type);
        $('#personForm').attr('action','afPaymentBill/toListPaymentBillPerson');
        $('#personForm').submit();
    }
