    ...
    <div class="col-lg-4">
        <div class="hpanel">
            ...
            <div class="panel-body border_borders">
               <h5>协议信息<span>协议号：ZY-EHR-20151222-0005</span></h5>
               <ul>
               	   <li>客户名称：上海润物科技有限公司</li>
                   <li>协议状态：未启用</li>
                   <li>联系人：张小姐</li>
                   <li>联系电话：13823456784</li>
                   <li>备注：因客户要求暂未使用</li>
               </ul>
            </div>
        </div>
                ...
                <div class="hpanel stats">
                    ...
                    <div class="panel-body h-200  none_borders">
                        <div class="stats-title">
                            <h5><a href="1.perfect_information.html">上海华润科技有限公司</a><span>在职人数204</span></h5>
                        </div>
    ...
    <div class="col-lg-4">
        <div class="hpanel">
            ...
            <div class="panel-body  none_borders">
                ...
                <ol>
                	<li class="green_birthday"><a href="#" class="green_birthday">3人</a>今日生日</li><!--a都链接到花名册-->
