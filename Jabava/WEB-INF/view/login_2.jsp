...
<!-- Page title -->
<title>JabavaV2.0 智阳网络</title>
<!-- Place favicon.ico and apple-touch-icon.png in the root directory -->
<!--<link rel="shortcut icon" type="image/ico" href="favicon.ico" />-->


<link rel="stylesheet" href="static/css/stylelogin.css"type="text/css">
<!--for 临时改变-->
<link rel="stylesheet" href="static/css/logins_1.css">
<script>
...
<body class="blank" style="background:#f6f6f6;">
	...
	<div class="splash">
		...
		<div class="splash-title">
			<h1>Jabava V1.0</h1>
			<p>属于你的专业人事专员</p>
			<img src="static/img/loading-bars.svg" width="64"
				height="64" />
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="hpanel">
 					...
 					<label class="control-label" for="companyCode">企业号</label> 
                    <input type="text" placeholder="请输入企业号" title="请输入企业号" required=""value="" name="companyCode" id="companyCode" class="form-control"> 
 					</div> -->
							<div class="form-group">
							...
							<a class="btn btn-default btn-block" href="to_register">注册</a>
