      ...
      <div class="panel-body">
        <div id="hbreadcrumb" class="m-t-xs m-b-xs">
          <h2 class="font-normal m-b-xs text-center">
            ${requestScope.ssPaymentBill.socialSecurityAccountName}${requestScope.ssPaymentBill.month}月清单明细-全部清单
          </h2>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
    ...
    function loadHeader(){
    	$.ajax({
			url:"ssPaymentBill/loadPaymentBillPersonHeader",
			type : "POST",
			dataType:'json',
    ...
    function initTable(columns){
    	detailTable = $('#detailTable').DataTable({
    		...
    		"ajax": {
    			"url": "ssPaymentBill/listPaymentBillPerson",
    			"data": {
