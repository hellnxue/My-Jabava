      ...
      <div class="panel-body">
        <div id="hbreadcrumb" class="m-t-xs m-b-xs">
          <h2 class="font-normal m-b-xs text-center">
            ${requestScope.ssPaymentBill.socialSecurityAccountName}${requestScope.ssPaymentBill.month}月清单明细-本月变更
          </h2>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
    ...
    function loadHeader(type){
    	$.ajax({
			url:"ssPaymentBill/" + (type == 'Tj' ? "loadPaymentBillPersonTjHeader" : "loadPaymentBillPersonBjHeader"),
			type : "POST",
			dataType:'json',
    ...
    function initTable(columns, type){
    	detailTable = $(type == 'Tj' ? '#tjTable' : '#bjTable').DataTable({
    		...
    		"ajax": {
    			"url": "ssPaymentBill/" + (type == 'Tj' ? "listPaymentBillPersonTj" : "listPaymentBillPersonBj"),
    			"data": {
