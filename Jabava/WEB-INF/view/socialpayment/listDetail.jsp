            ...
            <div class="hpanel">
                <div class="panel-heading">
                    <h4 class="text-center font-bold">
                      <a href="ssPaymentBill/toListPaymentBill" type="button" class="btn btn-success btn-sm pull-left btn-return m-r-md">返回</a>
...
<div style="display:none;">
	<form id="personForm" action="" method="post">
		<input type="hidden" id="ssPaymentBillId" name="ssPaymentBillId" value="${requestScope.ssPaymentBill.id}">
...
<script>
    ...
    function loadTable(){
        $('#detailTable').DataTable({
	        ...
	        "ordering": false,
	        "ajax": {
	        	"url":"ssPaymentBill/listPaymentBillDetail",
	        	"data": {ssPaymentBillId: ${requestScope.ssPaymentBill.id}}
	        },
	        "columns": [
	          { "data": "prod_name",
	        ...
	        "initComplete": function(settings, json) {
		        $('[data-type=total]').siblings().each(function(index, elem){
