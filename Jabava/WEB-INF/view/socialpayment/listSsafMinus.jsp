      ...
      <div class="panel-body">
        <div id="hbreadcrumb" class="m-t-xs m-b-xs">
          <h2 class="font-normal m-b-xs text-center">
            ${requestScope.ssPaymentBill.socialSecurityAccountName}${requestScope.ssPaymentBill.month}月清单明细-社保本月减员
          </h2>
        </div>
      </div>
    </div>
				...
				<div class="col-lg-12">
					<div class="hpanel">
						...
						<ul role="tabList" class="nav nav-tabs m-t-md" id="">
							...
							<li role="payDetails" class="active"><a href="#tab-1">本月减员</a>
							</li>
							<li role="payDetails"><a href="javascript: void(0);"
...
<script type="text/javascript">
    ...
    function loadHeader(){
    	$.ajax({
			url:"ssafPaymentBill/loadPaymentBillPersonJyHeader",
			type : "POST",
			dataType:'json',
    ...
    function initTable(columns){
    	detailTable = $('#detailTable').DataTable({
    		...
    		"ajax": {
    			"url": "ssafPaymentBill/listPaymentBillPersonJy",
    			"data": {
    ...
    function afLoadHeader(){
		$.ajax({
			url:"afPaymentBill/loadPaymentBillPersonJyHeader",
			type : "POST",
			dataType:'json',
	...
	function afInitTable(columns){
		afDetailTable = $('#afDetailTable').DataTable({
			...
			"ajax": {
				"url": "afPaymentBill/listPaymentBillPersonJy",
				"data": {
