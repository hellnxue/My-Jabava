      ...
      <div class="panel-body">
        <div id="hbreadcrumb" class="m-t-xs m-b-xs">
          <h2 class="font-normal m-b-xs text-center">
            ${requestScope.ssPaymentBill.socialSecurityAccountName}${requestScope.ssPaymentBill.month}月清单明细-社保全部清单
          </h2>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
          <div class="panel-body"> 
            <div class="table-responsive">
              <table id="afDetailTable" class="table table-bordered table-hover detailTable" width="100%">
              <thead>
              </thead>
              <tbody>
              </tbody>
...
<script type="text/javascript">
	...
	afPaymentBillId = '${requestScope.afPaymentBill.afPaymentBillId}';//公积金
	var detailTable;
	var afDetailTable;
    ...
    function loadHeader(){
    	$.ajax({
			url:"ssafPaymentBill/loadPaymentBillPersonHeader",
			type : "POST",
			dataType:'json',
	...
	function afLoadHeader(){
		$.ajax({
			url:"afPaymentBill/loadPaymentBillPersonHeader",
			type : "POST",
			dataType:'json',
	...
	function afInitTable(columns){
		afDetailTable = $('#afDetailTable').DataTable({
			...
			"ajax": {
				"url": "afPaymentBill/listPaymentBillPerson",
				"data": {
    ...
    function initTable(columns){
    	detailTable = $('#detailTable').DataTable({
    		...
    		"ajax": {
    			"url": "ssafPaymentBill/listPaymentBillPerson",
    			"data": {
