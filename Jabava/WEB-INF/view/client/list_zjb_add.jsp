    ...
    <div class="row">
        <div class="col-lg-12">
           ...
           <ul role="tabList" class="nav nav-tabs" id="">
              <li class="zy-ss-tab active"><a href="javascript://">增员</a></li>
...
<script type="text/javascript">
	$('#example2').DataTable({
		...
		"ajax": {
		    ...
		    "type":"POST",
		    "data": {hroOrderSendId: ${requestScope.hroOrderSend.hroOrderSendId}, type: "1"}
		},
		...
		"columns" : [
			...
			{"data" : "SB_BASE" },
			{"data" : "GJJ_BASE" },
			{"data" : "IS_CONSCIENCE", "render": function(data, type, row, meta){
				if(data == "1"){
					return "否";
				}else{
					return "是";
