    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          <ul role="tabList" class="nav nav-tabs" id="">
              ...
              <li class='zy-ss-tab'><a href="change/listDetail/${requestScope.hroOrderSend.hroOrderSendId }/3">减员</a></li>
              <li class="zy-ss-tab active"><a href="javascript://">变更</a></li>
          </ul>
      <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
          <div class="panel-body"> 
               <table id="example2" class="table table-striped table-bordered table-hover dataTable" width="100%">
                  <thead>
                      <tr>
                          <th>姓名</th>
                          <th>证件号</th>
	 ...
	 $('#example2').DataTable({
      ...
      "serverSide": false,
		"ajax": {
		    ...
		    "type":"POST",
		    "data": {hroOrderSendId: ${requestScope.hroOrderSend.hroOrderSendId}, type: "2"}
		},
