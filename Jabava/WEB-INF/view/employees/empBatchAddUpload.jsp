            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                       ...
                       <!-- 模板 -->
                          <div class="clearfix m-t-sm empBatchAddUpload">
                              <h5 class="text-info m-t">步骤一：下载模板</h5>
                                <ul class="m-l m-t-sm">
                                    <li> 1、批量新增员工用于员工批量入职或首次使用系统时批量新增员工信息；</li>
                                    <li> 2、可以一次性导入员工【个人信息】和【工作信息】全部信息；</li>
                                    <li> 3、也可以仅导入必填字段，其余信息通过【花名册】-【邀请员工完善信息】来完善（推荐）；</li>
                                    <li> 4、导入模板红色字体为必填项；</li>
                                    <li> 5、导入时根据“姓名+身份证号码”校验员工唯一性，当系统存在相同人员时，不允许新增；</li>
                                    <li> 6、系统已存在的员工，需要批量更新其信息时，请通过更新信息导入；</li>
                                   <li>
	        	...
	        	if(uploadFile.name!=null && uploadFile.name!=''){
	        		...
	        		if(postfix!='xlsx' && postfix!='xls' ){
	        	    	...
	        	    	$.ajax({
	        	    		...
	        	    		if(result.success){  
	        	    			window.location.href="employee/empUpdatePreview?type=insert";
	        	    		}else{
	        	    			 swal({
	                                 title: '上传失败',
	                                 text: result.msg,
