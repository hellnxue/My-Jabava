                    ...
                    <div class="panel-body">
                       ...
                       <div class="uploadPreview clearfix"> </div>                     
                          <!-- 预览 -->
                           <div class="empBatchAddPreview">
                            <div class="tishi clearfix m-t">
                               ...
                               <p class="m-l">正确可导入数据<span style="color:red;" class="insertBaseInfoTrueMsg"></span>条 <!-- <button class="btn btn-success btn-sm">查看详情</button> --></p>   
                               <p class="m-l">错误不可导入数据<span style="color:red;" class="insertBaseInfoFalseMsg"></span>条 　 <!-- <button class="btn btn-danger btn-sm">查看详情</button> --></p>  
                          </div>
                                ...
                                <ul class="nav nav-tabs">
                                 ...
                                 <div class="tab-content">
                                     <div id="personal" class="tab-pane active">
                                        <div class="panel-body">
                                           <table id="basePersonInfo" class="table table-striped table-responsive table-condensed table-hover table-bordered dataTable" width="100%">
                                              <thead>
                                              	<tr>
                                                  <th>序号</th>
												  <th>工号</th>
                                    ...
                                    <div id="job" class="tab-pane">
                                        <div class="panel-body">
                                           <table id="postPersonInfo" class="table table-striped table-condensed table-hover table-bordered dataTable" width="100%">
                                              <thead>
                                              	 <tr>
                                                 	<th>序号</th>
												   	<th>工号</th>
                                ...
                                <ul class="nav nav-tabs">
                                 ...
                                 <div class="tab-content">
                                     <div id="person" class="tab-pane active">
                                        <div class="panel-body">
                                           <table id="baseErrorPersonDet" class="table table-striped table-responsive table-condensed table-hover table-bordered dataTable" width="100%">
                                              <thead>
                                              	<tr>
                                                  <th>序号</th>
												  <th>工号</th>
                                    ...
                                    <div id="jobs" class="tab-pane">
                                        <div class="panel-body">
                                           <table id="postErrorPersonDet" class="table table-striped table-condensed table-hover table-bordered dataTable" width="100%">
                                              <thead>
                                              	 <tr>
                                                   	<th>序号</th>
												   	<th>工号</th>
                         ...
                         <div class="buttons text-center">
                            <a href="employees/empBatchAddUpload?type=insert" class="btn btn-default m-r">上一步</a>
                            <button class="btn btn-info" id="empBatchInsertImport">开始导入</button>
                        </div>
                        </div>
                          <!-- 预览结束 -->
                    </div>
...
<script src="static/js/empBatchAddUpload.js"></script>
</body>
</html>
