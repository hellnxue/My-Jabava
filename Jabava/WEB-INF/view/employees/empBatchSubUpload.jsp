            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                       ...
                       <!-- 模板 -->
                          <div class="clearfix m-t-sm empBatchSubUpload ">
                              <h5 class="text-info m-t">步骤一：下载模板</h5>
                                <ul class="m-l m-t-sm">
                                    <li> 1、批量更新员工子集信息用于系统中已存在的员工，通过导入批量新增员工的【教育信息】【合同信息】【履历信息】【社保信息】；</li>
                                    <li class="text-danger">  2、子集信息不能通过批量导入进行修改（一个人可能存在多条“教育信息、合同信息及履历信息”，导入后会对原信息进行覆盖）；</li>
                                    <li> 3、excel表中为空的字表或字段默认为不更新；</li>
                                    <li> 4、excel表中不为空的字段，按照相应内容更新对应字段数据；</li>
                                    <li> 5、导入时根据“姓名+身份证号码”判断联合唯一性；</li>
                                    <li> 6、系统不存在的员工，请通过新增员工导入；</li>
                                    <li>
                                        <a href="static/xls/base_sub_person_template.xlsx" type="button" class="btn btn-info">
	        	...
	        	if(uploadFile.name!=null && uploadFile.name!=''){
	        		...
	        		if(postfix!='xlsx' && postfix!='xls' ){
	        	    	...
	        	    	$.ajax({
	        	    		...
	        	    		if(result.success){
	        	    			window.location.href="employee/empBatchSubPreview";
	        	    		}else{
	        	    			 swal({
	                                 title: '上传失败',
	                                 text: result.msg,
