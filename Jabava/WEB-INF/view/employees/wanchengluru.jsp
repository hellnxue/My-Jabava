       ...
       <div class="teach">
        ...
        <!--教育背景弹框-->  
                       ...
                       <div class="shangchuan">
                        <h3>上传附件</h3>
                        	<div class="shangchuans">
                              ...
                              <div class="xiushan">
                                 <a href="#" class="pe-7s-note pe-2x xiugai" data-target="#myModal2" data-toggle="modal"></a>
                                 <a href="#" class="pe-7s-trash pe-2x demo4"></a>
                             </div>
                             </div>
                       </div>
          ...
          <div class="register-container containers" style="display:none;"> 
                   <div class="row">
                    <div class="col-lg-12">
                 <div class="modal fade hmodal-success form-row" id="myModal2" tabindex="-1" role="dialog"  aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="blue">
