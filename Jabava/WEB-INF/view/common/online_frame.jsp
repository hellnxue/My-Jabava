            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-body">
                        <iframe src="<%=JabavaPropertyCofigurer.getProperty("outerlink.im")%>?id=<%=orgLoginId%>&name=<%=user.getUserCode()%>" frameborder="0" width="100%" height="942" scrolling="yes"></iframe>
                    </div>
                </div>
            </div>
        </div>
