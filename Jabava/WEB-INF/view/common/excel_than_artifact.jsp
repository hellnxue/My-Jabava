...
<head>
    ...
    <!-- Page title -->
    <title>JabavaDemo | V1.0EXCEL比对神器</title>
            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-heading hbuilt jabava-built p-lg">
                        <h4 class="m-n font-bold">EXCEL比对神器</h4>
                    </div>
                    <div class="panel-body">
                        <iframe src="<%=JabavaPropertyCofigurer.getProperty("outerlink.excel")%>" frameborder="0" width="100%" height="942" scrolling="yes"></iframe>
                    </div>
                </div>
            </div>
        </div>
