...
<head>
    ...
    <!-- Page title -->
    <title>JabavaDemo | V1.0个税计算器</title>
            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-heading hbuilt jabava-built p-lg">
                        <h4 class="m-n font-bold">个税计算器</h4>
                    </div>
                    <div class="panel-body">
                        <iframe src="<%=JabavaPropertyCofigurer.getProperty("outerlink.tax")%>" frameborder="0" width="100%" height="580" scrolling="yes"></iframe>
                    </div>
                </div>
            </div>
        </div>
