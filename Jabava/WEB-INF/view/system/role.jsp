          ...
          <div class="hpanel">
            <div class="panel-heading ">
              <div class="text-right">
                <% if(RequestUtil.hasPower("index_role_ar")){ %>
            ...
            <div class="modal fade hmodal-success form-row" id="myModal10" tabindex="-1" role="dialog"  aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="color-line clearfix"></div>
                  <div class="modal-header">
                    <div class="row">
                      ...
                      <div class="col-sm-12 role_algin">
                        ...
                        <div class="form-group">
                          <ul class="nav nav-tabs" role="tablist">
                            <li class="active">
                              <a href="#profile" role="tab" id="menu_permissions" data-toggle="tab" aria-controls="profile">
                              菜单权限
                              </a>
                            </li>
                            <li>
                              <a href="#home" id="button_authority" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
                              按钮权限
                              </a>
                            </li>
                          </ul>
                          <div class="tab-content">
                            <div class="tab-pane fade" id="home" aria-labelledby="button_authority">
                            ...
                            <div class="tab-pane fade in active" id="profile" aria-labelledby="menu_permissions">
                              <div class="panel-body note-editor"> 
                                <div class="dd" id="nestable_tow">
...
<script type="text/javascript">
    ...
    var treeDemo2 = new Array();//菜单权限
        ...
        var setting = {
    	  ...
    	  $.ajax({
            ...
            var button = data.button;
              ...
              var getNodeType = button.type;
              button.realId=button.id;
              button.id=button.type+button.id;
          	  if(button.nodes != null && button.nodes != '' && button.nodes != 'undefined'){
          	    buttonTree(button.nodes,button.id);
          	  }
              switch(getNodeType){
                case 'menu':
                  button.icon = 'static/img/menu_close.png';
                  button.iconOpen = 'static/img/menu_open.png';
                  button.iconClose = 'static/img/menu_close.png';
                  break;
                case 'page':
                  button.icon = 'static/img/page_open.png'; 
                  button.iconOpen = 'static/img/page_close.png';
                  button.iconClose = 'static/img/page_open.png';
                  break;
                case 'button':
                  button.icon = 'static/img/btn.png'; 
                  break;
              }
          	  delete button.nodes;
  	...
  	//按钮权限
  	function buttonTree(node,pId){
  	  for(var i = 0; i < node.length; i++){
        var getNodeType = node[i].type;
        node[i].realId=node[i].id;
        node[i].id=node[i].type+node[i].id;
        node[i].pId=pId;
  	    if(node[i].nodes != null && node[i].nodes != '' && node[i].nodes != 'undefined'){
  	      buttonTree(node[i].nodes,node[i].id);
  	    }
        switch(getNodeType){
          case 'menu':
            node[i].icon = 'static/img/menu_close.png'; 
            node[i].iconOpen = 'static/img/menu_open.png';
            node[i].iconClose = 'static/img/menu_close.png'; 
            break;
          case 'page':
            node[i].icon = 'static/img/page_open.png'; 
            node[i].iconOpen = 'static/img/page_close.png';
            node[i].iconClose = 'static/img/page_open.png';
            break;
          case 'button':
            node[i].icon = 'static/img/btn.png'; 
            break;
        }
  	    delete node[i].nodes;
