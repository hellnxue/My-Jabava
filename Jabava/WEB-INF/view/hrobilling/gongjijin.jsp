        ...
        <div class="col-lg-12">
            <div class="hpanel">
         		<div class="panel-heading">
                    ...
                    <a href="shebao/gongjijinPageIndex" class="btn btn-success btn-sm pull-left">　返回　</a>
                    <span data-gongjijin="date">@gongjijinDate 公积金明细</span>
                    </h4>
                </div> 
      	...
      	table = $('#billTable').DataTable({
			...
			"columns": [
				...
				{ "data": "reportMonth" ,"render":function(data, type, row, meta) {
					$('[data-gongjijin=date]').text($('[data-gongjijin=date]').text().replace('@gongjijinDate',data));
					return data;
				}},
				{ "data": "employeeName" },
				{ "data": "cardId" },
				...
				{ "render": function render( data, type, row, meta ){
	            	//	return '<td><button class="btn btn-info btn-xs" type="button">支付</button></td>';
						return "<a href='shebao/gongjijinDetailPage?employeeId="+row.employeeId+"&reportMonth="+row.reportMonth+"&employeeName="+row.employeeName+"' ><button class='btn btn-success btn-xs dropdown-toggle' type='button'  title='查看'>查看</button></a>";//连接到社保详情界面
					} 
				}
			],
			"columnDefs": [
