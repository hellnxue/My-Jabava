...
<script>
	...
	var paramsObj={"policyGroupType": 2,reportMonth:"${requestScope.year}"};
    $(function () {
    	loadTable(paramsObj);
    ...
    function loadTable(params){
    	if(table){
      	...
      	table = $('#billTable').DataTable({
			...
			"columns": [
				{ "data": "reportMonth","render": function render( data, type, row, meta ){
					if(data == undefined){
						return paramsObj.reportMonth;
					}else{
	            		return data;
					}
	            } },
                ...
                { "render": function render( data, type, row, meta ){
                        return '<td><a class="btn btn-success btn-xs" type="button" href="shebao/gongjijinPage?reportMonth='+row.reportMonth+'">明细</a></td>';
                //      return '<td>&nbsp;</td>'
                    } 
                 }
			],
