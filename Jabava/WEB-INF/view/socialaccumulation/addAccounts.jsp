                        ...
                        <form class="form-horizontal" data-form="addAccounts" autocomplete="off">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-offset-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 form-required">
                                        <input type="text" name="socialSecurityCode" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-offset-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 form-required">
                                        <input type="text" class="form-control" name="accumulationFundCode">
                                        <span class="help-block small">如果您不知道社保和公积金账户编号，请询问HR或服务提供商。
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <nav class="navbar navbar-default" data-container="tabnv">
                        <ul class="nav nav-tabs m-l-lg m-r-lg" role="tablist">
                            <li role="presentation">
                                <a href="javascript://" aria-controls="addTab" role="tab" data-toggle="addTab">
...
<script src="static/js/socialaccumulation/addAccounts.js"></script>
</body>
</html>