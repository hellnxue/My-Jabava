            ...
            <div class="row">
                              ...
                              <form class="form-horizontal" id="addForm" data-form-type="add" data-form="validator">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-5 form-required">
                                            <select class="form-control" id="addLocationCity" name="locationCityId">
                                                <option ></option>                                               
                                            </select>
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-9 form-required">
                                                <select class="form-control select2" id="addSocialSecurityRule" name="socialSecurityRule" multiple="multiple">
                                                    <option ></option>                                                
                                                </select>
                            ...
                            <div class="modal-header">
                             ...
                             <form class="form-horizontal" id="editForm" data-form-type="edit" data-form="validator">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-5 form-required">
                                            <select class="form-control" id="updatelocationCity" name="locationCityId">
                                                <option > </option>
                                            </select>
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label class="control-label col-xs-6 col-sm-6 col-md-6 col-lg-3">参保规则：</label>
                                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-9 form-required">
                                                <select class="form-control select2" id="updateSocialSecurityRule" name="socialSecurityRule" multiple="multiple">
                                                    <option  > </option>
                                                </select>
                                                <span class="help-block">请选择至少一项参保规则</span>
                                            </div>
                ...
                <!-- 修改end -->
                        ...
                        <div class="panel-body m-t-md"> 
                            <table id="newsTable" class="table table-condensed table-hover table-bordered dataTable" width="100%">
                                <thead>
                                <tr>
                                    <th>新闻标题</th>
                                  <!--   <th>社保账户编号</th>
    		  ...
    		  $.ajax({
 				...
 				success : function(result) {
 					 ...
 					 if(result && result.length>0){
 						 for(var i=0;i<result.length;i++){
 	 			    		 $("#addSocialSecurityRule").append("<option value='"+result[i].id+"'>"+result[i].sbGroupName+"</option>");
 	 			    	}
    		...
    		if(cityId=='请选择'){
    		  ...
    		  $.ajax({
 				...
 				success : function(result) {
 					 ...
 					 if(result && result.length>0){
 						 for(var i=0;i<result.length;i++){
 	 			    		 $("#updateSocialSecurityRule").append("<option value='"+result[i].id+"'>"+result[i].sbGroupName+"</option>");
 	 			    	}  
 					 } 
			...
			"columns": [
               ...
               /*  { "data": "socialSecurityCode" },
				...
				{ "render": function render( data, type, row, meta ){
						return '<button class="btn btn-success btn-xs" data-target="[data-modal=editSalaryDate]" data-toggle="modal" type="button" onclick="mod(' + row.socialSecurityAccountId + ');">修改</button>&nbsp;' +
  	  ...
  	  $.ajax({
			...
			success : function(result) {
					if(result){
					     ...
					     //参保地的省份
					    $("#updateProvince option").each(function (){  
					    	 if ($(this).val() == result.provinceId) {  
					     ...
					     $.ajax({
				 				...
				 				success : function(result) {
				 					 ...
				 					 $("#updatelocationCity").append("<option >请选择 </option>"); 	 	
				 			    	for(var i=0;i<result.length;i++){
				 			    		if(result[i].cityId==locationCityId){
				 			    			//参保地为选中状态
				 			    			 $("#updatelocationCity").append("<option selected=selected value='"+result[i].cityId+"'>"+result[i].cityName+"</option>");
				 			    		}else{
				 			    			 $("#updatelocationCity").append("<option  value='"+result[i].cityId+"'>"+result[i].cityName+"</option>");
				 				...
				 				success : function(res) {
				 					 ...
				 					 if(res && res.length>0){
				 						 for(var i=0;i<res.length;i++){
				 	 			    		 $("#updateSocialSecurityRule").append("<option  value='"+res[i].id+"'>"+res[i].sbGroupName+"</option>");
