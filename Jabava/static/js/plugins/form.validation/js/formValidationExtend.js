/**
 * [IDValidator China ID number validator]
 *  @author https://github.com/caipeiming/myutils
 *  @methods 
 *  IDValidator.isValid(code) return true || false
 *  IDValidator.getInfo(code) return info || false
 *  
 */
