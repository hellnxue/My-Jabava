        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-offset-3">
            <div class="form-group">
                ...
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 no-gutter">
                    <div class="col-xs-6">
                        <p class="form-control-static" data-name="provinceName"></p>
                    </div>
                    <div class="col-xs-6">
                        <p class="form-control-static" data-name="cityName"></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-offset-3 hidden">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                    <div class="form-control" role="textarea" data-policy-type="securityRule">
                        <ul class="list-group" data-name="securityRule" data-type="list">
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                    <div class="form-control" role="textarea" data-policy-type="accumulationRule">
                        <ul class="list-group" data-name="accumulationRule" data-type="list">
                        </ul>
                    </div>
                </div>
            </div>
